...
public class HtmlParser {
    ...
    private static String convertCharset(String in) {
        ...
        int pos;
        while ((pos = stringBuffer.indexOf("\\u")) > -1) {
            String temp = stringBuffer.substring(pos,pos + 6);
            stringBuffer.replace(pos, pos + 6, Character.toString((char) Integer.parseInt(temp.substring(2), 16)));
        }
